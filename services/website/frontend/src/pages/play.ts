    ...
    <section class="min-h-screen flex flex-col px-4 py-10">
      ...
      <div class="flex-1 flex flex-col items-center justify-center">
        ...
        <form id="game-form" class="grid gap-8 md:grid-cols-2 w-full max-w-4xl">
          ...
          <div class="md:col-span-2 mt-10 flex justify-center md:justify-end">
            <button type="submit" class="btn-menu btn-menu-play border border-slate-500 hover:border-white transition">
